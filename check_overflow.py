...
def compute_bound(model):
    ...
    for name,layer in model.named_modules():
        if isinstance(layer,int_linear_fake.QuantLinear):
            ...
            mean_q = stat[layer_idx]["q_mean"]
            mean_k = stat[layer_idx]["k_mean"]
            ...
            mean_v = stat[layer_idx]["v_mean"]
            mean_s = stat[layer_idx]["s_mean"]
